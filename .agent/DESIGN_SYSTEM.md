...
```tsx
// MCIA-inspired flower line art
<svg className="absolute -left-32 -top-32 w-[600px] h-[600px] 
                opacity-[0.12] animate-spin-slower" 
     viewBox="0 0 400 400" fill="none">
  <g transform="translate(200, 200)">
    {/* 8 Petals in yellow, orange, red */}
    <ellipse cx="0" cy="-80" rx="25" ry="100" 
             transform="rotate(0)" 
...
**Design Rationale:**
- **Filipino Heritage**: Inspired by MCIA logo flower
- **Subtle Movement**: Very slow rotation (120s+) for ambient feel
- **Color Harmony**: Yellow, orange, red petals match brand
- **Counter-rotating**: Two flowers spin opposite directions
- **Low Opacity**: 10-12% to stay in background
