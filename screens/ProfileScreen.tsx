...
const ProfileScreen: React.FC<Props> = ({ onNavigate }) => {
  return (
    <div className="min-h-screen pb-24">
      {/* Header */}
      <div className="bg-gradient-to-br from-violet-600/20 to-indigo-600/20 backdrop-blur-xl border-b border-white/10 p-8 pt-safe rounded-b-[2.5rem] relative overflow-hidden">
