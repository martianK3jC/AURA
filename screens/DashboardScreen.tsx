        ...
        <div className="flex justify-between items-start mb-4">
            ...
            <div className="glass-card rounded-full p-1 flex gap-1">
                <button 
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-bold transition-colors ${!isStress ? 'bg-emerald-500 text-white' : 'text-slate-400 hover:text-white'}`}
                >
                  A
                </button>
                <button 
                  onClick={() => onSetScenario('B')} 
                  className={`px-3 py-1 rounded-full text-xs font-bold transition-colors ${isStress ? 'bg-orange-500 text-white' : 'text-slate-400 hover:text-white'}`}
                >
                  B
                </button>
            </div>
